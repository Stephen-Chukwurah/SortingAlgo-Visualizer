...
class AppEffects {
    constructor(actions$) {
        ...
        this.setDataSize = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_0__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_0__["ofType"])(_app_actions__WEBPACK_IMPORTED_MODULE_2__["setDataSize"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((action) => {
...
const ɵ1 = (state, action) => (Object.assign({}, state, { currentPane: action.data })), ɵ2 = (state, action) => (Object.assign({}, state, { data: action.data })), ɵ3 = (state, action) => (Object.assign({}, state, { dataSize: action.data })), ɵ4 = (state, action) => (Object.assign({}, state, { isSorting: true })), ɵ5 = (state, action) => (Object.assign({}, state, { isSorting: false }));
const reducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createReducer"])(entityInitialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_1__["loadCurrentPane"], ɵ1), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_1__["loadData"], ɵ2), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_1__["setDataSize"], ɵ3), 
// on(Actions.sortData, (state, action) => ({...state, data: null})),
Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_1__["triggerIsSorting"], ɵ4), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["on"])(_app_actions__WEBPACK_IMPORTED_MODULE_1__["triggerNotSorting"], ɵ5));
...
const ɵ0 = (app) => app.data;
const getData = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureSelector, ɵ0);
const ɵ1 = (app) => app.dataSize;
const getDataSize = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureSelector, ɵ1);
const ɵ2 = (app) => app.currentPane;
const getCurrentPane = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureSelector, ɵ2);
const ɵ3 = (app) => app.isSorting;
const getIsSorting = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(featureSelector, ɵ3);
const query = {
    getData,
    getDataSize,
    getCurrentPane,
...
class SortService {
    ...
    doSort(barContainer) {
        this.setTimer();
        this.facade.currentPane$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["take"])(1)).subscribe((pane) => {
            switch (pane.id) {
                case 1: {
    ...
    insertionSort(barContainer) {
        ...
        for (let i = 1; i < barList.length; i++) {
            setTimeout(() => {
                currentValue = this.getHeightValue(barList[i].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`));
                key = currentValue;
                j = i - 1;
                while (j >= 0 && key < this.getHeightValue(barList[j].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`))) {
                    temp = this.getHeightValue(barList[j].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`));
                    barList[j].firstElementChild.setAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`, `${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["UTILS"].defaultColor} height: ${this.getHeightValue(barList[j + 1].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`))}%;`);
        ...
        for (let i = 0; i < barList.length - 1; i++) {
            setTimeout(() => {
                for (let j = 0; j < barList.length - 1 - i; j++) {
                    if (this.getHeightValue(barList[j].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`)) > this.getHeightValue(barList[j + 1].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`))) {
                        temp = this.getHeightValue(barList[j].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`));
                        barList[j].firstElementChild.setAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`, `${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["UTILS"].defaultColor} height: ${this.getHeightValue(barList[j + 1].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`))}%;`);
                        barList[j + 1].firstElementChild.setAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`, `${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["UTILS"].defaultColor} height: ${temp}%;`);
                    }
    ...
    partition(items, left, right) {
        let pivot = this.getHeightValue(items[Math.floor((right + left) / 2)].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`)), //middle element
        i = left, //left pointer
        ...
        while (i <= j) {
            ...
            if (i <= j) {
                let temp = this.getHeightValue(items[i].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`));
        ...
        for (let i = 0; i < barList.length; i++) {
            setTimeout(() => {
                ...
                for (let j = i; j < barList.length; j++) {
                    currentIterableValue = this.getHeightValue(barList[j].firstElementChild.getAttribute(`${_constants_utils_constants__WEBPACK_IMPORTED_MODULE_1__["STR"].style}`));
